...
export const MARQUEE_TEXT =
  "React, Next.js, Node, MongoDb, Express, Css, Typescript, Shadcn, Tailwind, Html, Javascript,";
...
export const PROJECTS = [
  {
    ...
    title: "Giphy-Clone",
    description:
      "A full-featured giphy-clone website built with React and Tailwind css.",
    // imgSrc: project1,
    imgSrc: project1,
    link: "https://giphy-clone-blush.vercel.app/",
  },
  {
    id: 2,
    title: "Unsplash-Images",
    description:
      "Created an unsplash-images website using Unsplash API and React Query to fetch the data built with React and Tailwind css.",
    imgSrc: project2,
